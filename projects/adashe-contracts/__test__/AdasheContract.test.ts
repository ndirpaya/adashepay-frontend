...
import { AdasheContractClient } from '../contracts/clients/AdasheContractClient';

const fixture = algorandFixture();
algokit.Config.configure({ populateAppCallResources: true });

let appClient: AdasheContractClient;

describe('AdasheContract', () => {
  ...
  beforeAll(async () => {
    ...
    appClient = new AdasheContractClient(
      {
        sender: testAccount,
        resolveBy: 'id',
        id: 0,
